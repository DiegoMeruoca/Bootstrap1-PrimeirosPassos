$("#btCalc").click(function(){//Cria uma função caso o usuario clique no botão
	let nome=$("#nome").val();//Atribui o valor do input na variavel
	let n1=parseFloat($("#nota1").val());//Atribui o valor do input na variavel
	let n2=parseFloat($("#nota2").val());//Atribui o valor do input na variavel
	let n3=parseFloat($("#nota3").val());//Atribui o valor do input na variavel
	let n4=parseFloat($("#nota4").val());//Atribui o valor do input na variavel
	let media=(n1+n2+n3+n4)/4;//Calcula a media
	if(media>=7){
		aprovado(nome,media);	
	}else{
		if(media<5){
